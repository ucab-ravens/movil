  ...
  ResultAsync<Iterable<Course>> findAll() async {
    ...
    try{ 
      ...
      if (response.statusCode == 200) {
        ...
        return Error(Exception('Error al obtener los cursos desde el servidor. $response'));
      }
    }
    catch(e){
      return Error(Exception('Error al obtener los cursos desde la fuente de datos. $e'));
    }
  }
  ...
  ResultAsync<Course> findById(CourseId id) async {
    ...
    try{ 
      ...
      if (response.statusCode == 200) {
        ...
        return Course.fromMap(map).fold(
          (error) => Error(error), 
